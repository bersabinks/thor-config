...
émulateurs, ROMs, sauvegardes, PS Vita et launcher. Chaque action est **vérifiée** après coup et le rapport
...
src/modules/<module>/     logique des modules (prepare, emulators, roms, saves, vita, launcher)
