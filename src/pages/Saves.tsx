...
import { SavesModule } from '../components/SavesModule'
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-desc">
            Coffre-fort de sauvegardes vérifiées bit-à-bit, avec snapshot de sécurité avant toute
            restauration.
          </p>
        </div>
        <DeviceStatus />
