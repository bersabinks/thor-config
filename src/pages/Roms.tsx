...
import { RomsModule } from '../components/RomsModule'
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-desc">
            Identifie, range et transfère automatiquement les fichiers déposés dans le dossier
            d'import — sans clic « scanner ».
          </p>
        </div>
        <DeviceStatus />
      </div>
